# MACROPAD Hotkeys example: Safari and Chrome for Mac
...
app = {                    # REQUIRED dict, must be named 'app'
    ...
    'macros': [           # List of button macros...
        ...
        # 4th row ----------
        (0x000000, 'GH', [Keycode.COMMAND, 'n', -Keycode.COMMAND,
                           'github.com\n']),   # Adafruit in new window
        (0x800000, 'Masto', [Keycode.COMMAND, 'n', -Keycode.COMMAND,
                            'macaw.social/home\n']),   # Digi-Key in new window
        (0x101010, 'HAD', [Keycode.COMMAND, 'n', -Keycode.COMMAND,
